            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <section class="bg-white/50 dark:bg-black/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <div class="flex items-start gap-3 mb-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-900 dark:text-white">imageSize</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-900 dark:text-white">image Modified</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="bg-white/50 dark:bg-black/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p class="text-sm text-gray-900 dark:text-white">image format</p>
                    </section>

                    {/* Category */}
                    <section class="bg-white/50 dark:bg-black/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Category</p>
                        <p class="text-sm text-gray-900 dark:text-white">image categorie</p>
                    </section>
                    ...
                    <section class="bg-white/50 dark:bg-black/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            />
                            <p class="text-sm text-gray-900 dark:text-white">image Marked</p>
                        </div>
                    </section>
                </div>
            </div>
